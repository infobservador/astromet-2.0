...
import { evaluarBanderaRoja } from "./seguridad";
import { notaConfianza } from "./confianzaPronostico";
...
const ACTIVIDADES_ALTERNATIVAS = [
  ...
  "juegos interactivos de orientación estelar para todas las edades (por ejemplo, armar constelaciones con linternas o encontrarlas en cartas del cielo)",
  ...
  "una charla de mitología y cosmovisiones del cielo nocturno de distintas culturas (mapuche, guaraní, incaica, griega, etc.), con relatos e ilustraciones",
  "material táctil y descripciones auditivas del cielo nocturno para personas ciegas o con baja visión (modelos 3D de constelaciones o planetas, audioguías), que además enriquecen la experiencia para todo el grupo",
];
...
export function generarDescripcionNoche(bloques, datosSolLuna, bortleInfo, inicioVentana) {
  ...
  // La seguridad va primero: si hay condiciones realmente peligrosas, esto anula
  // cualquier otra recomendación (ninguna actividad alternativa vale un riesgo real).
